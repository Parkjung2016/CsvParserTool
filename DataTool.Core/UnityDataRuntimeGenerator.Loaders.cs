...
namespace CSVParserTool
{
    public static partial class UnityDataRuntimeGenerator
    {
        private static string BuildDataSheetLoader()
        {
            ...
            sb.AppendLine("// Unity: com.unity.addressables 패키지가 필요합니다. CSV와 Bytes 데이터를 Addressables로 로드합니다.");
            ...
            sb.AppendLine("    }");
            sb.AppendLine(); sb.AppendLine("    /// <summary>파이프(|)로 구분된 셀 값을 배열로 변환합니다.</summary>");
            ...
            sb.AppendLine("    }");
            sb.AppendLine();
            sb.AppendLine("    /// <summary>Addressables 또는 Unity Editor 경로에서 Export된 CSV/Bytes 데이터를 로드합니다.</summary>");
            ...
            sb.AppendLine("        /// Unity Editor의 <c>EditorPrefs</c>에서 CSV/Bytes 로드 방식을 선택합니다.");
            sb.AppendLine("        /// false이면 CSV를, true이면 <c>.bytes</c> 파일을 사용합니다.");
            sb.AppendLine("        /// </summary>");
            ...
            sb.AppendLine("        }");
            sb.AppendLine();
            sb.AppendLine("        /// <summary>Bytes Addressables 키 접두사입니다. 예: <c>\"Content/Bytes/\"</c> + <c>DT_Test.bytes</c>.</summary>");
            sb.AppendLine("        public static string AddressableBytesKeyPrefix { get; set; } = \"Content/Bytes/\";");
            sb.AppendLine();
            sb.AppendLine("        /// <summary>CSV Addressables 키 접두사입니다. 예: <c>\"Content/CSV/\"</c> + <c>DT_Test.csv</c>.</summary>");
            sb.AppendLine("        public static string AddressableCsvKeyPrefix { get; set; } = \"Content/CSV/\";");
            sb.AppendLine();
            sb.AppendLine("        /// <summary>한 번에 로드할 테이블 수입니다. Addressables 부하를 분산합니다.</summary>");
            sb.AppendLine("        public static int LoadBatchSize { get; set; } = 8;");
            sb.AppendLine();
            sb.AppendLine("#if UNITY_EDITOR");
            sb.AppendLine("        /// <summary>Unity Editor에서 사용할 Assets 기준 데이터 루트 경로입니다.</summary>");
            ...
            sb.AppendLine("        }");
            sb.AppendLine();
            sb.AppendLine("        /// <summary><see cref=\"GlobalDataContainer\"/>의 모든 public 컨테이너를 비동기로 로드합니다.</summary>");
            ...
            sb.AppendLine("        }");
            sb.AppendLine();
            sb.AppendLine("        /// <summary><see cref=\"GlobalDataContainer\"/>의 모든 public 컨테이너를 동기 방식으로 로드합니다.</summary>");
